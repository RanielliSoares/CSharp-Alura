...
void ExibirMediaBandas()
{
    ...
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
        ...
        Console.Write($"\na Banda {nomeDaBanda} tem uma média de: {notasDaBanda.Average()}");
        Console.WriteLine("\nDigite uma tecla para voltar ao menu principal");
        Console.ReadKey();
        Console.Clear();
        ExibirOpcoesDoMenu();
    ...
    {
        Console.WriteLine($"\nA banda {nomeDaBanda} não está cadastrada!");
        Console.WriteLine("\nDigite uma tecla para voltar ao menu principal");
        Console.ReadKey();
        Console.Clear();
        ExibirOpcoesDoMenu();
...
void AvaliarUmaBanda()
{
    ...
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
        Console.Write($"Qual nota você quer astribuir para a banda {nomeDaBanda}: ");
